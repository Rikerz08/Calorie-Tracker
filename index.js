...
// declare outside the function so it can be called exclusive of the calculateCalories function
...
function calculateCalories(e) {
  ...
  document.getElementById("cals-remaining").innerHTML = Math.round(
    totalCalories.value
  );

  document.getElementById("cal-intake").innerHTML = Math.round(
    totalCalories.value
  );
}
...
const ItemCtrl = (function () {
  ...
  const data = {
    ...
    currentItem: null,
    // This is for the counter for the sake of the function
    remainingCalories2: 0,
  };
  ...
  return {
    ...
    getTotCalories: function () {
      ...
      data.remainingCalories2 = totalCalories.value - cal;
      return data.remainingCalories2;
    },
...
const UICrtl = (function () {
  ...
  return {
    ...
    updateTotCalories: function (calsRem) {
      document.querySelector(UISelectors.calsRemaining).innerHTML = calsRem;
    },
...
const App = (function (ItemCtrl, StorageCtrl, UICrtl) {
  ...
  const itemAddSubmit = function (e) {
    ...
    if (input.name !== "" && input.calories !== "") {
      ...
      //Get total calorie
      const calsRem = ItemCtrl.getTotCalories();

      //Update calorie.
      UICrtl.updateTotCalories(calsRem);
